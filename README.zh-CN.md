...
这个项目把 AES-256-GCM 做成了一个普通人也能用的 Android 工具：输入一句话，得到一串密文，发出去；对方输入同样的密码，还原出原文。**从你到收信人之间，第三方插不上手，也读不懂一个字；你想说的悄悄话，不必先被谁听见，更不必先被谁过一遍。**

**你说的话，中间没人读得懂；你想说的悄悄话，不必先被谁听见。**
